...
did an execellent job of grouping similar images while allowing for render noise.
"""
...
BUNDLE_PATH = ROOT / "data/datasets/corner-maze-render-base-images"
...
OUTPUT_BUNDLE_PATH = BUNDLE_PATH.parent / f"{BUNDLE_PATH.name}-duplicate-groups-{int(PER_CHANNEL_TOLERANCE)}-{int(MEAN_TOLERANCE)}"
...
CSV_OUTPUT_PATH = OUTPUT_BUNDLE_PATH / f"{BUNDLE_PATH.name}-duplicate-groups-{int(PER_CHANNEL_TOLERANCE)}-{int(MEAN_TOLERANCE)}.csv"
