...
DEFAULT_GROUPING_CSV = DEFAULT_DATASET_DIR / f"{DEFAULT_DATASET_DIR.name}.csv"
DEFAULT_OUTPUT_DIR = ROOT_DIR / "data/datasets/corner-maze-render-base-images-consolidated"
