...
BUNDLE_PATH: Union[str, Path, None] = Path(
    "/Users/ryangrgurich/VS Code Local/corner-maze-encoder-pretrain/data/pt-files/corner-maze-render-base-images-dataset.pt"
)
...
OUTPUT_BUNDLE_PATH: Union[str, Path, None] = Path(
    f"/Users/ryangrgurich/VS Code Local/corner-maze-encoder-pretrain/data/pt-files/corner-maze-render-base-images-duplicate-groups-{int(PER_CHANNEL_TOLERANCE)}-{int(MEAN_TOLERANCE)}.pt"
)

# Default path for saving duplicate group report (set to None to disable file output).
REPORT_PATH: Union[str, Path, None] = Path(
    f"/Users/ryangrgurich/VS Code Local/corner-maze-encoder-pretrain/data/reports/corner-maze-render-base-images-duplicate-groups-{int(PER_CHANNEL_TOLERANCE)}-{int(MEAN_TOLERANCE)}.json"
)
