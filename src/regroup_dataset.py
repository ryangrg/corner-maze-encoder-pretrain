...
DEFAULT_DATASET_DIR = ROOT_DIR / "data/datasets/base-images-ds"
DEFAULT_REGROUP_CSV = ROOT_DIR / "data/csv/base-images-regroups-partitioned-52-1-acute.csv"
DEFAULT_OUTPUT_DIR = DEFAULT_DATASET_DIR.parent / f"base-images-regrouped-partitioned-52-1-acute-ds"
